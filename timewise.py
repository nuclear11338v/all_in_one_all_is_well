...
def send_good_morning():
    for user_id in user_ids:
        bot.send_photo(user_id, "https://graph.org/file/bf067788a313dde08c58f-48a5aff2c2ed5a785a.jpg", caption="🌞 𝙶𝚘𝚘𝚍 𝚖𝚘𝚛𝚗𝚒𝚗𝚐! 🌼\n\n✨𝚆𝚒𝚜𝚑𝚒𝚗𝚐 𝚢𝚘𝚞 𝚊 𝚍𝚊𝚢 𝚏𝚒𝚕𝚕𝚎𝚍 𝚠𝚒𝚝𝚑 𝚙𝚘𝚜𝚒𝚝𝚒𝚟𝚒𝚝𝚢 𝚊𝚗𝚍 𝚓𝚘𝚢. 🌈\n\n𝙼𝚊𝚢 𝚎𝚟𝚎𝚛𝚢 𝚖𝚘𝚖𝚎𝚗𝚝 𝚋𝚛𝚒𝚗𝚐 𝚢𝚘𝚞 𝚊 𝚛𝚎𝚊𝚜𝚘𝚗 𝚝𝚘 𝚜𝚖𝚒𝚕𝚎 😊\n𝚊𝚗𝚍 𝚎𝚊𝚌𝚑 𝚌𝚑𝚊𝚕𝚕𝚎𝚗𝚐𝚎 𝚋𝚎 𝚊𝚗 𝚘𝚙𝚙𝚘𝚛𝚝𝚞𝚗𝚒𝚝𝚢 𝚝𝚘 𝚐𝚛𝚘𝚠. 🌟\n\n𝚁𝚎𝚖𝚎𝚖𝚋𝚎𝚛, 𝚝𝚘𝚍𝚊𝚢 𝚒𝚜 𝚊 𝚋𝚕𝚊𝚗𝚔 𝚌𝚊𝚗𝚟𝚊𝚜—𝚙𝚊𝚒𝚗𝚝 𝚒𝚝 𝚋𝚎𝚊𝚞𝚝𝚒𝚏𝚞𝚕𝚕𝚢! 🎨\n\n𝙷𝚊𝚟𝚎 𝚊𝚗 𝚊𝚖𝚊𝚣𝚒𝚗𝚐 𝚍𝚊𝚢 𝚊𝚑𝚎𝚊𝚍! 💖!")

# Function to send a good afternoon message
def send_good_afternoon():
    for user_id in user_ids:
        bot.send_photo(user_id, "https://graph.org/file/767bfc3f0cb2d61ab2882-c01696337a5e17b55b.jpg", caption="☀️ ᴳᵒᵒᵈ ᵃᶠᵗᵉʳⁿᵒᵒⁿ! 🌻\n\nᴵ ʰᵒᵖᵉ ʸᵒᵘʳ ᵈᵃʸ ⁱˢ ᵍᵒⁱⁿᵍ ʷᵒⁿᵈᵉʳᶠᵘˡˡʸ! 🌈\nᵀᵃᵏᵉ ᵃ ᵐᵒᵐᵉⁿᵗ ᵗᵒ ᵇʳᵉᵃᵗʰᵉ ᵈᵉᵉᵖˡʸ, ᵃᵖᵖʳᵉᶜⁱᵃᵗᵉⁿᵗʰᵉ ˡⁱᵗᵗˡᵉ\nᵗʰⁱⁿᵍˢ, ᵃⁿᵈ ᵏᵉᵉᵖ ᵖᵘˢʰⁱⁿᵍ ᶠᵒʳʷᵃʳᵈ. 💪\nʸᵒᵘ'ᵛᵉ ᵍᵒᵗ ᵗʰⁱˢ! 🌟\n\nᴱⁿʲᵒʸ ᵗʰᵉ ʳᵉˢᵗ ᵒᶠ ʸᵒᵘʳ ᵈᵃʸ! 😃")

# Function to send a good night message
def send_good_night():
    for user_id in user_ids:
        bot.send_photo(user_id, "https://graph.org/file/75bde7e75cf97addc3f1b-1957d73f6aed105c63.jpg", caption="🌙 ɢᴏᴏᴅ ɴɪɢʜᴛ! 😴\n\nᴀᴤ ᴛʜᴇ ᴅᴀʏ ᴄᴏᴍᴇᴤ ᴛᴏ ᴀ ᴄʟᴏᴤᴇ, ᴛᴀᴋᴇ ᴀ\nᴍᴏᴍᴇɴᴛɴᴛᴏ ʀᴇᴈʟᴇᴄᴛ ᴏɴ ᴀʟʟ ᴛʜᴇ\nᴡᴏɴᴅᴇʀᴈᴜʟ ᴛʜɪɴɢᴤ ᴛʜᴀᴛ ʜᴀᴘᴘᴇɴᴇᴅ. 🌟\n\nᴍᴀʏ ʏᴏᴜʀ ᴅʀᴇᴀᴍᴤ ʙᴇ ᴤᴡᴇᴇᴛ ᴀɴᴅ ʏᴏᴜʀ ʀᴇᴤᴛ ʙᴇ ᴘᴇᴀᴄᴇᴈᴜʟ. 💤\n\nʀᴇᴍᴇᴍʙᴇʀ, ᴛᴏᴍᴏʀʀᴏᴡ ɪᴤ ᴀ ɴᴇᴡ ᴏᴘᴘᴏʀᴛᴜɴɪᴛʏ ᴛᴏ ᴤʜɪɴᴇ! 🌅\n\nɴᴤʟᴇᴇᴘ ᴡᴇʟʟ! 💖")
...
def set_channel_id(message):
    ...
    if len(command) < 2:
        bot.send_message(user_id, "❌ ᴾˡᵉᵃˢᵉ ᵖʳᵒᵛⁱᵈᵉ ᵃ ᶜʰᵃⁿⁿᵉˡ ᴵᴰ ᵃᶠᵗᵉʳ ᵗʰᵉ\n⦿ /ˢᵉᵗ ᶜᵒᵐᵐᵃⁿᵈ, ˡⁱᵏᵉ ᵗʰⁱˢ:ⁿ/ˢᵉᵗ -1002342033433 ᵒʳ\n\n⦿ /ˢᵉᵗ 138384742838")
        return
    ...
    if channel_id not in user_ids:
        ...
        save_user_ids()
        bot.send_message(user_id, "⦿ ✅ ᶜʰᵃⁿⁿᵉˡ ᴵᴰ ˢᵃᵛᵉᵈ ˢᵘᶜᶜᵉˢˢᶠᵘˡˡʸ")
    else:
        bot.send_message(user_id, "⚠️ ᵀʰⁱˢ ᶜʰᵃⁿⁿᵉˡ ᴵᴰ ᵃˡʳᵉᵃᵈʸ ᵉˣⁱˢᵗˢ")
...
def start(message):
    ...
    if is_channel:
        if chat_id not in channel_ids:
            ...
            save_channel_ids()
            bot.send_message(chat_id, "✅ ᶜʰᵃⁿⁿᵉˡ ᴵᴰ ʳᵉᶜᵒʳᵈᵉᵈ ˢᵘᶜᶜᵉˢˢᶠᵘˡˡʸ")
    else:
    ...
    keyboard.add(types.InlineKeyboardButton("➕ ᴬᵈᵈ ᴹᵉ ᵗᵒ ʸᵒᵘʳ ᶜʰᵃⁿⁿᵉˡ ➕", url=f"https://t.me/{bot.get_me().username}?startchannel=true"))
    keyboard.add(types.InlineKeyboardButton("👨‍💻 𝙳𝙴𝚅𝙴𝙻𝙾𝙿𝙴𝚁", url="https://t.me/MR_ARMAN_OWNER"))

    bot.send_message(chat_id, "👋 𝚆𝚎𝚕𝚌𝚘𝚖𝚎 𝚝𝚘 𝚃𝚒𝚖𝚎𝚆𝚒𝚜𝚎𝙱𝚘𝚝!\n\n𝙸 𝚜𝚎𝚗𝚍 𝚍𝚊𝚒𝚕𝚢 𝚐𝚛𝚎𝚎𝚝𝚒𝚗𝚐𝚜...\n\n𝙰𝙳𝙳 𝙼𝙴 𝚃𝙾 𝚈𝙾𝚄𝚁 𝙶𝚁𝙾𝚄𝙿 𝙸𝙻𝙻 𝙳𝙴𝙻𝙴𝚃𝙴 𝙰𝙻𝙻 𝙰𝙱𝚄𝚂𝙸𝚅𝙴 𝚆𝙾𝚁𝙳'𝚂\n𝙰𝙽𝙳 𝙼𝚄𝚃𝙴𝚂 𝚆𝙷𝙾 𝚂𝙴𝙽𝙳 𝙰𝙱𝚄𝚂𝙸𝚅𝙴 𝚆𝙾𝚁𝙳𝚂\n\n/𝚜𝚎𝚝 -1002727727 𝚢𝚘 𝚜𝚎𝚝 𝚢𝚘𝚞𝚛 𝚌𝚑𝚊𝚗𝚗𝚎l",
...
def handle_abusive_message(message):
    ...
    if warnings[str(user_id)] >= 3:
        try:
            ...
            mute_text = f"⦿ 🚫 ᵁˢᵉʳ ᴹᵘᵗᵉᵈ!\n\n⚠️ {message.from_user.first_name} ʰᵃˢ ᵇᵉᵉⁿ ᵐᵘᵗᵉᵈ ᶠᵒʳ ᵘˢⁱⁿᵍ ᵃᵇᵘˢⁱᵛᵉ ˡᵃⁿᵍᵘᵃᵍᵉ!"
            keyboard = types.InlineKeyboardMarkup()
            unmute_button = types.InlineKeyboardButton("🔓 ̶U̶n̶m̶u̶t̶e", callback_data=f"unmute_{user_id}")
        ...
        warn_text = f"⦿ ⚠️ 𝚆𝚊𝚛𝚗𝚒𝚗𝚐 {warnings[str(user_id)]}➣/❸\n\n🚫 {message.from_user.first_name}, 𝚜𝚝𝚘𝚙 𝚞𝚜𝚒𝚗𝚐 𝚊𝚋𝚞𝚜𝚒𝚟𝚎 𝚠𝚘𝚛𝚍𝚜!"
...
def unmute_user(call):
    ...
    if not is_admin(chat_id, call.from_user.id):
        bot.answer_callback_query(call.id, "⦿ ❌ ᴼⁿˡʸ ᵃᵈᵐⁱⁿˢ ᶜᵃⁿ ᵘⁿᵐᵘᵗᵉ ᵘˢᵉʳˢ")
        return
